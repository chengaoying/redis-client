...
/**
 * 基于sentinel监控工具实现redis分片的连接池，连接池对象初始化方式有两种：
 * 方式一：使用spring ioc容器初始化，如下：
 ...
 *				<set>
 *					<value>192.168.145.128:26379</value>
 *					<value>192.168.145.129:26379</value>
 *				</set>
 *			</constructor-arg>
 *	 	</bean>
 *
 ...
 *		sentinels.add("192.168.145.129:26379");
 *   
			...
			try {
					...
					public void onMessage(String channel, String message) {
					    ...
					    if (switchMasterMsg.length > 3) {
							...
							log.severe("Invalid message received on Sentinel "
								+ host + ":" + port + " on channel +switch-master: " + message);
					    }
					}
			    }, "+switch-master");
			    ...
			    if (running.get()) {
					log.severe("Lost connection to Sentinel at " + host
						+ ":" + port + ". Sleeping 5000ms and retrying.");
					try {
